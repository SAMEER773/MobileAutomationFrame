...
import MobileEnums.WaitStrategy;
import mobileDriver.MobileDriverManager;
import mobileReports.MobileExtentLogger;
...
public class MobileExplicitWaitFactories {
	 ...
	 public static void click(WebElement element, WaitStrategy waitStrategy, String description) {
	    ...
	    public static void getText(WebElement element, WaitStrategy waitStrategy, String description) {
	        waitUntilCondition(element, waitStrategy);
	        element.getText();
